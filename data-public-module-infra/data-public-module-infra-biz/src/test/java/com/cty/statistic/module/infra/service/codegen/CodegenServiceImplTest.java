package com.cty.statistic.module.infra.service.codegen;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.map.MapUtil;
import com.cty.statistic.framework.common.pojo.PageResult;
import com.cty.statistic.framework.test.core.ut.BaseDbUnitTest;
import com.cty.statistic.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import com.cty.statistic.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import com.cty.statistic.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import com.cty.statistic.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import com.cty.statistic.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.cty.statistic.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.cty.statistic.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.cty.statistic.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import com.cty.statistic.module.infra.dal.mysql.codegen.CodegenTableMapper;
import com.cty.statistic.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.cty.statistic.module.infra.enums.codegen.CodegenSceneEnum;
import com.cty.statistic.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.cty.statistic.module.infra.framework.codegen.config.CodegenProperties;
import com.cty.statistic.module.infra.service.codegen.inner.CodegenBuilder;
import com.cty.statistic.module.infra.service.codegen.inner.CodegenEngine;
import com.cty.statistic.module.infra.service.db.DatabaseTableService;
import com.cty.statistic.module.system.api.user.AdminUserApi;
import com.cty.statistic.module.system.api.user.dto.AdminUserRespDTO;
...
import static com.cty.statistic.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.cty.statistic.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.cty.statistic.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.cty.statistic.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.cty.statistic.framework.test.core.util.AssertUtils.assertServiceException;
import static com.cty.statistic.framework.test.core.util.RandomUtils.*;
import static com.cty.statistic.module.infra.enums.ErrorCodeConstants.*;
