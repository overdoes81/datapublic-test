package com.cty.statistic.module.infra.service.logger;
...
import com.cty.statistic.module.infra.api.logger.dto.ApiErrorLogCreateReqDTO;
import com.cty.statistic.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.cty.statistic.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.cty.statistic.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.cty.statistic.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.cty.statistic.framework.common.util.date.LocalDateTimeUtils.*;
...
import static com.cty.statistic.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.cty.statistic.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("data-public-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("data-public-test");
