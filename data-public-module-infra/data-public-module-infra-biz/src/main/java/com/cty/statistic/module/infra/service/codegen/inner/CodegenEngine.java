package com.cty.statistic.module.infra.service.codegen.inner;
...
import com.cty.statistic.framework.common.exception.util.ServiceExceptionUtil;
...
import com.cty.statistic.framework.common.util.date.LocalDateTimeUtils;
...
import com.cty.statistic.framework.common.util.string.StrUtils;
...
import com.cty.statistic.framework.excel.core.util.ExcelUtils;
...
import com.cty.statistic.framework.operatelog.core.enums.OperateTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "data-public-module-${table.moduleName}/" + // 顶级模块
                "data-public-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "data-public-module-${table.moduleName}/" + // 顶级模块
                "data-public-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "data-public-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "data-public-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
