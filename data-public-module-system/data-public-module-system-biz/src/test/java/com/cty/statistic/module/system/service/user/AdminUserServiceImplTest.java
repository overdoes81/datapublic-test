package com.cty.statistic.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.cty.statistic.framework.common.enums.CommonStatusEnum;
import com.cty.statistic.framework.common.exception.ServiceException;
import com.cty.statistic.framework.common.pojo.PageResult;
import com.cty.statistic.framework.common.util.collection.ArrayUtils;
...
import com.cty.statistic.module.infra.api.file.FileApi;
import com.cty.statistic.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.cty.statistic.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.cty.statistic.module.system.controller.admin.user.vo.user.*;
...
import com.cty.statistic.module.system.dal.dataobject.dept.UserPostDO;
import com.cty.statistic.module.system.dal.dataobject.tenant.TenantDO;
import com.cty.statistic.module.system.dal.dataobject.user.AdminUserDO;
import com.cty.statistic.module.system.dal.mysql.dept.UserPostMapper;
import com.cty.statistic.module.system.dal.mysql.user.AdminUserMapper;
import com.cty.statistic.module.system.enums.common.SexEnum;
import com.cty.statistic.module.system.service.dept.DeptService;
import com.cty.statistic.module.system.service.dept.PostService;
import com.cty.statistic.module.system.service.permission.PermissionService;
import com.cty.statistic.module.system.service.tenant.TenantService;
...
import static com.cty.statistic.framework.common.util.collection.SetUtils.asSet;
...
import static com.cty.statistic.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("data-publicyuanma");
        ...
        assertEquals("data-publicyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("data-publicyuanma"))).thenReturn("java");
