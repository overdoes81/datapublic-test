package com.cty.statistic.module.member.controller.admin.config;

import com.cty.statistic.framework.common.pojo.CommonResult;
import com.cty.statistic.module.member.controller.admin.config.vo.MemberConfigRespVO;
import com.cty.statistic.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import com.cty.statistic.module.member.convert.config.MemberConfigConvert;
import com.cty.statistic.module.member.dal.dataobject.config.MemberConfigDO;
import com.cty.statistic.module.member.service.config.MemberConfigService;
