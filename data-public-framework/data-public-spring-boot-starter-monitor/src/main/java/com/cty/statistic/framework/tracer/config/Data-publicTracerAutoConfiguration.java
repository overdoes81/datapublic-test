...
import com.cty.statistic.framework.tracer.core.aop.BizTraceAspect;
import com.cty.statistic.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "data-public.tracer", value = "enable", matchIfMissing = true)
public class Data-publicTracerAutoConfiguration {
