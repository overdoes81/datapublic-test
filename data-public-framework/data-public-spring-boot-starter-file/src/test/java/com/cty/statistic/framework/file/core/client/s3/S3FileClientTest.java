...
public class S3FileClientTest {
    ...
    public void testMinIO() throws Exception {
        ...
        config.setBucket("data-publicyuanma");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.data-public.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.data-public.iocoder.cn
        // 默认上海的 endpoint
