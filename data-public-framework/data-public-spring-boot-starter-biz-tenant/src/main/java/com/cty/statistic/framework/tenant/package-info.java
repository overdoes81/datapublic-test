 ...
 *      1）Spring Async：
 *          {@link com.cty.statistic.framework.quartz.config.Data-publicAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 Data-publicSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.cty.statistic.framework.tenant;
