...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.cty.statistic";
    private static final String ARTIFACT_ID = "data-public";
    private static final String PACKAGE_NAME = "com.cty.statistic";
    private static final String TITLE = "数公基鄂州";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.cty.statistic";
        String artifactIdNew = "data-public";
        String packageNameNew = "com.cty.statistic";
        String titleNew = "数公基鄂州";
        String projectBaseDirNew = projectBaseDir + "-test"; // 一键改名后，“新”项目所在的目录  // 一键改名后，“新”项目所在的目录
